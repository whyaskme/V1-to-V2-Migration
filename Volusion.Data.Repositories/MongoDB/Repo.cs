...
using Volusion.Data.Models;
using Volusion.Utilities;

using TimeZone = Volusion.Data.Models.TimeZone;
    ...
    public class Repo
    {
        ...
        public Repo()
        {
            try
            {
                ...
                var client = new MongoClient("mongodb+srv://elite-io:!13324BossWood@cluster0.wluzv.mongodb.net/References?retryWrites=true&w=majority");
                var database = client.GetDatabase("References");
